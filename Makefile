...
.PHONY: all tidy dockerbuild helm-package publish beta dev test help
...
help:
	@echo "make - 使用 Dockerfile 构建镜像"
	@echo "make dev - 在开发模式下运行 Go 服务"
	@echo "make publish - 构建镜像、推送镜像，并打包 Helm"
